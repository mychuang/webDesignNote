...
enum LumensCommand {
  ...
  init_position_last_mem = '0104756A03',
  init_position_1st_preset = '0104756A02',
  init_position_last_mem_on = '01043F0100',
  init_position_1ast_mem_off = '01043F0000',
  cam_name = '01CE'
}
...
class Camera implements ICameraControl {
  ...
  async getCV605(){
    let data = await this.sendInqCommand(LumensInquiryCommand.inq_CV605)
